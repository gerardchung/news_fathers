...
p + geom_point(alpha = .6, size =1.5) +
  ...
  labs(title = "Number of news articles with 'fathers' in titles from 1992 to 2020",
       subtitle = "In <b><span style = 'color: #E41A1C;'>**Straits Times**</span></b>, <b><span style = 'color: #377EB8;'>**TodayOnline**</span></b>, and <b><span style = 'color: #4DAF4A;'>**CNA**</span></b>",
       caption = "Plot by **Gerard Chung** | gerardchung.com | Codes at **github.com/gerardchung/news_fathers**<br>Note: **'father'** in title include *dad*, *father*, *paternal*") +
  ...
  ) +  # this line of code is to have two captions
